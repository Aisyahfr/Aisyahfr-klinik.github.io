...
<body class="hold-transition layout-top-nav">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card card-primary card-outline">
                                <div class="card-header">
                                    <h5 class="card-title m-0">Form Pasien</h5>
                                </div>
                                <div class="card-body">

                                    <form action="fungsi/simpanPasien.php" method="POST">
                                        <input type="hidden" name="status" id="status" value="Tambah">
                                        <input type="hidden" name="idPasienTxt" id="idPasienTxt">

                                        <div class="form-group">
                                            <label for="">Nomor Identitas</label>
                                            <input type="text" class="form-control form-control-sm" name="noIdentitasTxt" id="noIdentitasTxt" required="required">
                                        </div>

                                        <div class="form-group">
                                            <label for="">Nama Pasien</label>
                                            <input type="text" class="form-control form-control-sm" name="namaPasienTxt" id="namaPasienTxt" required="required">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row ml-1">
                                                <div class="custom-control custom-radio col-md-6">
                                                    <input class="custom-control-input" type="radio" id="jkL" name="jenisKelamin" value="L" required>
                                                    <label for="jkL" class="custom-control-label">Laki-laki</label>
                                                </div>
                                                <div class="custom-control custom-radio col-md-6">
                                                    <input class="custom-control-input" type="radio" id="jkP" name="jenisKelamin" value="P">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-sm" name="umurTxt" id="umurTxt" required="required">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <button class="btn btn-sm btn-success" type="submit" id="tombol">Tambah Pasien</button>
                        ...
                        <div class="col-md-8">
                            <div class="card card-primary card-outline">
                                <div class="card-header">
                                    <h5 class="card-title m-0">Daftar Pasien</h5>
                                </div>
                                <div class="card-body">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?= $data['telepon'] ?></td>
                                                        <td>
                                                            <a href="fungsi/hapusPasien.php?id=<?= $data['id_pasien'] ?>" class="btn btn-sm btn-danger" title="Delete">&nbsp;<i class="fas fa-times"></i>&nbsp;</a>
                                                            <button class="btn btn-sm btn-warning" title="Edit" onclick="edit(<?= $data['id_pasien'] ?>)"> <i class="fas fa-pencil-alt"></i> </button>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
    ...
    <script>
        ...
        function edit(id) {
            $.ajax({
                "url": "fungsi/getPasien.php?id=" + id,
                "method": "GET",
            }).done(function(response) {
                var object = JSON.parse(response);
                console.log(object);
                $("#status").val('Edit');
                $("#idPasienTxt").val(object[0][0]);
                $("#noIdentitasTxt").val(object[0][1]);
                $("#namaPasienTxt").val(object[0][2]);
                if (object[0][3] == "L") {
                    $("#jkL").attr('checked', 'checked');
                } else {
                    $("#jkP").attr('checked', 'checked');
                }
                $("#umurTxt").val(object[0][4]);
                $("#teleponTxt").val(object[0][5]);
                $("#tombol").html("Edit Pasien");
            });
        }
    </script>
</body>
